...
echo.
.\engine\gzdoom.exe -iwad ..\STRIFE1.WAD -config .\engine\config\StrifeCoop.ini -file ..\StrifeCoop.pk3 %morefiles% -host %playercount% +skill %skill% +name %playername% +map map02 +sv_nocrouch 1 +sv_noplayerclip 1 +sv_nothingspawn 1 +sv_coopsharekeys 1 +sv_localitems 1
